...
class BlogAdapter(private val blogItemList: List<BlogItem>, private val context: Context) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(blogItem.img == "img1") {
            holder.blogImage.setBackgroundResource(R.drawable.img1)
        }
        else if(blogItem.img == "img2"){
            holder.blogImage.setBackgroundResource(R.drawable.img2)
        }
        else if(blogItem.img == "img3"){
            holder.blogImage.setBackgroundResource(R.drawable.img3)
        }
        else {
            holder.blogImage.setBackgroundResource(R.drawable.img4)
        }
